...
sys.path.append("/media/voanhnhat/SDD_OUTSIDE1/PROJECT_DETECT_OBJECT/checkpoints")
sam2_checkpoint = "sam2.1_hiera_base_plus.pt"

sys.path.append("/media/voanhnhat/SDD_OUTSIDE1/PROJECT_DETECT_OBJECT/configs")
